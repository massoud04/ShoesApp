    ...
    Box(
        ...
        Box(
            modifier = Modifier
                .fillMaxSize()
                .alpha(0.3f)
                .background(color = Color(android.graphics.Color.parseColor(product.color)), shape = RoundedCornerShape(22.dp))
        )
        ...
        Image(
            modifier = Modifier
                ...
                .size(240.dp)
                .offset(30.dp, (-20).dp),
            painter = rememberImagePainter(data = product.imageResource), // Use Coil to load the image from the URL
...
fun ProductBigCardPreview() {
    ProductBigCard(
        ...
        product = ProductUiModel(
            imageResource = "https://firebasestorage.googleapis.com/v0/b/shoesapp-6697c.appspot.com/o/s_1.png?alt=media&token=98f45cf5-618c-4065-9a05-2563f47e6abd",
            color = "#FF5722",
            name = "SA",
            price = 128.99f,
            oldPrice = 168.99f,
